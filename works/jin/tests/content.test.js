...
test('魔物誌：基本職をすべて網羅し、欄がそろう', () => {
  for (const id of Object.keys(CLASSES)) {
    ...
    if (EXPANSION_CLASSES.includes(id) || EXPANSION2_CLASSES.includes(id) || EXPANSION3_CLASSES.includes(id) || EXPANSION4_CLASSES.includes(id) || EXPANSION5_CLASSES.includes(id)) continue;
