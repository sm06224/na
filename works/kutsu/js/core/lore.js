...
export const MONSTER_LORE = {
  ...
  slug: '鈍重な岩蛞蝓。這った跡が武具を錆びさせる。',
  hawk: '岩棚の鷹。鋭く舞い、軌道が読めない。',
  hobgoblin: '一回り大きいゴブリン。隊を率いて押し寄せる。',
  wererat: '鼠の獣人。群れで素早く噛みつき、毒を盛る。',
  ooze: '酸の泥。鈍いが、触れた武具を溶かす。',
  dervish: '舞い踊る剣士。速さと回避でかく乱する。',
  ettin: '二つの頭を持つ鬼。交互に殴り、休まない。',
  cockatrice: '鶏の蛇。その嘴に触れると身が石のように固まる。',
  efreet: '炎をまとう魔人。火球を放ち、炎を意に介さない。',
  shoggoth: '蠢く原初の塊。あらゆるものを溶かし、傷は塞がる。深層の悪夢。',
  mole: '目の見えぬ土竜。物音だけを頼りに掘り進む。',
  viper: '青い蝮。ひと噛みに強い毒を盛る。',
  draugr: '冷たい海の屍。寒気と毒を寄せつけず、重く斬りつける。',
  quasit: '小悪魔クァジット。火を放ち、ふいに消える。',
  succubus: '夢魔。心を惑わせ、雷を呼ぶ。',
  wyrm: '古竜の影法師。闇の炎を吐き、仔竜を呼ぶ。窟の最奥に潜むもう一つのヌシ。',
};
