...
export const CLASSES = {
  warrior: {
    ...
    abilities: ['cleave', 'warcry', 'bulwark', 'quake', 'shieldwall'],
  ...
  mage: {
    ...
    abilities: ['firebolt', 'frostbolt', 'blink', 'wardshield', 'icelance'],
  ...
  rogue: {
    ...
    abilities: ['sneak', 'dagger_throw', 'blink', 'shadowstep'],
  ...
  ranger: {
    ...
    abilities: ['aimed_shot', 'volley', 'herbal', 'snipe'],
